        ...
        switch (type){
            case 0:
                ...
                if(!exist){
                    ...
                    td4.innerHTML = '<span onclick="decrease(this)">-</span><input type="text" value="1" oninput="change(this)" onpropertychange="change(this)"><span onclick="increase(this)">+</span>';
